...
Revision ID: 71a6abb00621
Revises: 315c29dd8970
Create Date: 2025-03-28 20:59:56.781722
...
revision: str = '71a6abb00621'
down_revision: Union[str, None] = '315c29dd8970'
...
def upgrade() -> None:
    ...
    sa.Column('image_ids', sa.String(length=1000), nullable=True),
    sa.PrimaryKeyConstraint('match_report_id'),
    mysql_engine='InnoDB'
    )
    ...
    op.add_column('matches', sa.Column('match_report_id', sa.Uuid(), nullable=True))
    op.create_index(op.f('ix_matches_match_report_id'), 'matches', ['match_report_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_matches_match_report_id'), table_name='matches')
    op.drop_column('matches', 'match_report_id')
    op.drop_constraint('fk_matches_match_id', 'match_errors', type_='foreignkey')
