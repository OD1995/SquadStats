"""add col for cloudinary for abrordob

Revision ID: 6c453aed700b
Revises: 71a6abb00621
Create Date: 2025-03-29 22:36:23.642158
...
revision: str = '6c453aed700b'
down_revision: Union[str, None] = '71a6abb00621'
...
def upgrade() -> None:
    ...
    op.add_column('abrordob_markers', sa.Column('image_url_id', sa.String(length=100), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('abrordob_markers', 'image_url_id')
    # ### end Alembic commands ###
