"""add uuid to league_seasons

Revision ID: 855d3af4995c
Revises: a2bfb8bc9128
Create Date: 2024-11-09 19:41:27.575121
...
revision: str = '855d3af4995c'
down_revision: Union[str, None] = 'a2bfb8bc9128'
...
def upgrade() -> None:
    ...
    op.add_column('league_seasons', sa.Column('league_season_id', sa.Uuid(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('league_seasons', 'league_season_id')
    op.drop_constraint('fk_team_seasons_team_season_id', 'competitions', type_='foreignkey')
