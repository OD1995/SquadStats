...
Revision ID: a0e73bc042ef
Revises: b8f700728f6a
Create Date: 2024-11-16 16:10:28.229914
...
revision: str = 'a0e73bc042ef'
down_revision: Union[str, None] = 'b8f700728f6a'
...
def upgrade() -> None:
    ...
    op.alter_column('matches', 'location',
