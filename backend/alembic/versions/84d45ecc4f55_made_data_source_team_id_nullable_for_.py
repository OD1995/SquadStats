"""made data_source_team_id nullable for teams

Revision ID: 84d45ecc4f55
Revises: ac367c2a265c
Create Date: 2025-02-03 23:06:34.602453
...
revision: str = '84d45ecc4f55'
down_revision: Union[str, None] = 'ac367c2a265c'
...
def upgrade() -> None:
    ...
    op.alter_column('teams', 'data_source_team_id',
