...
Revision ID: 78308d016fea
Revises: 469e8b32a2a3
Create Date: 2024-11-16 15:13:17.512187
...
revision: str = '78308d016fea'
down_revision: Union[str, None] = '469e8b32a2a3'
...
def upgrade() -> None:
    ...
    op.add_column('matches', sa.Column('pens_for', sa.Integer(), nullable=False))
    op.add_column('matches', sa.Column('pens_against', sa.Integer(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('matches', 'pens_against')
    op.drop_column('matches', 'pens_for')
    op.drop_constraint('fk_data_sources_data_source_id', 'leagues', type_='foreignkey')
